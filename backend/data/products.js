const products = [
    {
      name: "Britania Sandwich Bread",
      imageUrl:
      "https://ik.imagekit.io/dunzo/dunzo-catalog-prod/tr:w-220,h-220,cm-pad_resize_store_thumbnail/stores/72fe7b54-f6e4-4186-9603-3c6b604e11cc-1591952821676-store_image.jpeg",
      description:
    ...
    {
      name: "Saffola Classical Masala Oats",
      imageUrl:
    ...
    {
      name: "Cadbury Hot Choclate Drink Mix",
      imageUrl:
